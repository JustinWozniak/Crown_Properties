...
public class FavoriteListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FavoriteListActivity.this, FindAgentsActivity.class);
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, FavoritesData.ITEMS, mTwoPane));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final List<FavoritesData.FavoriteProperty> mValues;
        private final boolean mTwoPane;
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FavoritesData.FavoriteProperty item = (FavoritesData.FavoriteProperty) view.getTag();
                if (mTwoPane) {
        ...
        SimpleItemRecyclerViewAdapter(FavoriteListActivity parent,
                                      List<FavoritesData.FavoriteProperty> items,
                                      boolean twoPane) {
            mValues = items;
