...
import com.wozzytheprogrammer.kwproperty.Favorites.m_FireBase.FirebaseHelper;
...
3.DATA INPUT
 */
public class MainFavoritesActivity extends AppCompatActivity {
    ...
    private void displayInputDialog()
    {
        ...
        d.setContentView(R.layout.favorites_input_dialog);
            ...
            public void onClick(View v) {
                ...
                if(name != null && name.length()>0)
                {
                    ...
                    if(helper.save(s))
                    {
                        ...
                        adapter=new FavoriteCustomAdapter(MainFavoritesActivity.this,helper.retrieve());
                        lv.setAdapter(adapter);
                ...
                {
                    Toast.makeText(MainFavoritesActivity.this, "Name Must Not Be Empty", Toast.LENGTH_SHORT).show();
                }
